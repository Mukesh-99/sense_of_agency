...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\labsong\\Downloads\\IB_new_task_March5\\IB_new_task_March5\\IB_task_new_practice_lastrun.py',
...
mainExpLoop = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('cond_LR_prac.xlsx', selection='0:5'),
