...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\mukes.DESKTOP-PFSHT1J\\Downloads\\IB_new_task_Feb7\\IB_new_task_Feb7\\IB_task_new_practice.py',
...
leftList = ['L','L','L','L','L','R','R','R','R','R', 'L','L','L','L','L','R','R','R','R','R'];
shuffle(leftList)

rightList = ['L','L','L','L','L','R','R','R','R','R','L','L','L','L','L','R','R','R','R','R'];
shuffle(rightList)
...
for thisMainExpLoop in mainExpLoop:
    ...
    thisExp.addData('rightBar.started', rightBar.tStartRefresh)
    thisExp.addData('rightBar.stopped', rightBar.tStopRefresh)
    ...
    # update component parameters for each repeat
    # keep track of which components have finished
    delay_mainComponents = [text_2, background_2, post_left_2, post_right_2, football_2, leftGesture_2, rightGesture_2]
    ...
    thisExp.addData('leftGesture_2.started', leftGesture_2.tStartRefresh)
    thisExp.addData('leftGesture_2.stopped', leftGesture_2.tStopRefresh)
    thisExp.addData('rightGesture_2.started', rightGesture_2.tStartRefresh)
    thisExp.addData('rightGesture_2.stopped', rightGesture_2.tStopRefresh)
    ...
    for thisMotionLoop in motionLoop:
        ...
        # keep track of which components have finished
        target_mainComponents = [background_3, post_left_3, post_right_3, football_3, leftGesture_3, rightGesture_3]
        ...
        thisExp.addData('leftGesture_3.started', leftGesture_3.tStartRefresh)
        thisExp.addData('leftGesture_3.stopped', leftGesture_3.tStopRefresh)
        thisExp.addData('rightGesture_3.started', rightGesture_3.tStartRefresh)
        thisExp.addData('rightGesture_3.stopped', rightGesture_3.tStopRefresh)
    ...
    timing_slider.reset()
    # keep track of which components have finished
    resp_mainComponents = [timing_slider, submit_button, timing_question]
