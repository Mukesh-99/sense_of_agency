...
game_state_dict["current_state"] = 0
game_state_dict["time_entered_state"] = 0
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/derekwacks/Downloads/IB_new_task_March17/IB_task_new_training.py',
...
# Setup the Window
win = visual.Window(
    size=[1440, 810], fullscr=False, screen=0, #size=[1280, 720], fullscr=True, screen=0,
...
Instructions_2 = visual.TextStim(win=win, name='Instructions_2',
    text='Welcome\n\nIn this block, you will learn to report the time interval between your gesture and the onset of the beep.\n\nIn each trial, performing the power-grasp will trigger an auditory beep.\n\nThe first 5 trials will be examples of 0ms delays. The next 5 trials will have 1000ms delays. After, you will do training trials with delays varying between 0ms to 1000ms.\n\nYou will report the delay between your gesture and the onset of the beep by choosing a number between 0ms to 1000ms. Afterwards you will receive the value of the actual delay to improvise future guesses.\n\n\n Perform power-grasp to continue.\n',
    font='Arial',
...
Instructions_3 = visual.TextStim(win=win, name='Instructions_3',
    text='Perform a power grasp to initiate a beep',
    font='Arial',
...
shortExampleLoop_counter = 100
for thisShortExample in shortExample:

    shortExampleLoop_counter+=1
    ...
    while continueRoutine:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = shortExampleLoop_counter + 0.1  # intention_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
        ...
        if intention_keys.status == STARTED and not waitOnFlip:
            theseKeys = intention_keys.getKeys(keyList=['escape', 'space'], waitRelease=False)
    ...
    while continueRoutine:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = shortExampleLoop_counter + 0.2  # delay_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = shortExampleLoop_counter + 0.3  # target_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = shortExampleLoop_counter + 0.4  # feedback
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
...
longExampleLoop_counter = 200

for thisLongExample in LongExample:

    longExampleLoop_counter+=1
    ...
    while continueRoutine:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = longExampleLoop_counter + 0.1  # intention_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = longExampleLoop_counter + 0.2  # delay_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = longExampleLoop_counter + 0.3  # target_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = longExampleLoop_counter + 0.4  # feedback
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
...
for thisMainExpLoop in mainExpLoop:
    ...
    while continueRoutine:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = main_loop_counter + 0.1  # intention_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = main_loop_counter + 0.2  # delay_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = main_loop_counter + 0.3  # target_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = main_loop_counter + 0.4  # resp_main
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # update game_state
        if first_loop == True:
            game_state_dict["current_state"] = main_loop_counter + 0.5  # feedback
            game_state_dict["time_entered_state"] = time.time() - start_time
            first_loop = False
